describe("match.ip", function()
  ...
  it("positive", function()
    ...
    assert.equal('0.0.0.0', ip('0.0.0.0/255.255.255.255'))
    assert.equal('1.2.3.4', ip('1.2.3.4/255.255.255.255'))
    assert.equal('8.8.8.8', ip('8.8.8.8/255.255.255.255'))
    assert.equal('255.255.255.255', ip('255.255.255.255/255.255.255.255'))
  end)
